...
<html lang="pt-br">
  ...
  <head>
    ...
    <!-- Css 3.0 -->
    <link rel="stylesheet" type="text/css" href="incept/css/principal-pt.css">
          ...
          <div class="nocturne">
            ...
            <div class="container">
              <div class="pt-5 my-5 py-5 text-center controlers">
                ...
                <div class="projeto image" data-item="design" style="background-image: url(incept/img/8.jpeg);"onclick="openProductPage('Campanha do Dia das Mães', 'R. Prates', 'incept/img/8.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Campanha do Dia das Mães</h1>
                              <p class="pauthor">R. Prates</p>
                          </div>
                      </div>
                  </div>
                  <div class="projeto image" data-item="dev" style="background-image: url(incept/img/principal-lj.png);"onclick="openProductPage('Campanha Contra a Discriminação Racial', 'R. Prates', 'incept/img/1.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Loja de Móveis E-commerce</h1>
                              <p class="pauthor">E. Sousa</p>
                          </div>
                      </div>
                  </div>
                  <div class="projeto image" data-item="design" style="background-image: url(incept/img/5.jpeg);"onclick="openProductPage('Celebração da Semana Santa', 'R. Prates', 'incept/img/5.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Celebração da Semana Santa</h1>
                              <p class="pauthor">R. Prates</p>
                          </div>
                      </div>
                  </div>
                  <div class="projeto image" data-item="dev" style="background-image: url(incept/img/principal-mc.png);"onclick="openProductPage('Campanha de Doação de Sangue', 'R. Prates', 'incept/img/7.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Loja de Acessórios Femininos E-commerce</h1>
                              <p class="pauthor">E. Sousa</p>
                          </div>
                      </div>
                  </div>

                  <div class="projeto image" data-item="ads" style="background-image: url(incept/img/13.jpg);"onclick="openProductPage('Dia de Tiradentes', 'R. Prates', 'incept/img/13.jpg')">
                      <div class="gobody overlay">
                          <div class="relative">
                  ...
                  <div class="projeto image" data-item="dev" style="background-image: url(incept/img/principal-rr.png);"onclick="openProductPage('Promoção de Produtos', 'R. Prates', 'incept/img/11.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Loja de Roupas Femininas E-commerce</h1>
                              <p class="pauthor">E. Sousa</p>
                          </div>
                      </div>
                  </div>
                  <div class="projeto image" data-item="design" style="background-image: url(incept/img/12.jpg);"onclick="openProductPage('Semana Santa', 'R. Prates', 'incept/img/12.jpg')">
                      <div class="gobody overlay">
                          <div class="relative">
                  ...
                  <div class="projeto image" data-item="ads" style="background-image: url(incept/img/3.jpeg);"onclick="openProductPage('Promoção de Produtos', 'R. Prates', 'incept/img/3.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                  ...
                  <div class="projeto image" data-item="ads" style="background-image: url(incept/img/4.jpeg);"onclick="openProductPage('Campanha de Segurança no Trânsito', 'R. Prates', 'incept/img/4.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Campanha de Segurança no Trânsito</h1>
                              <p class="pauthor">R. Prates</p>
                          </div>
                      </div>
                  </div>
                  <div class="projeto image" data-item="ads" style="background-image: url(incept/img/6.jpeg);"onclick="openProductPage('Descobrimento do Brasil', 'R. Prates', 'incept/img/6.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                  ...
                  <div class="projeto image" data-item="dev" style="background-image: url(incept/img/principal-pb.png);"onclick="openProductPage('Promoção de Produtos', 'R. Prates', 'incept/img/2.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Institucional de Posto de Gasolina</h1>
                              <p class="pauthor">E. Sousa</p>
                          </div>
                      </div>
                  </div>
                  <div class="projeto image" data-item="design" style="background-image: url(incept/img/9.jpeg);"onclick="openProductPage('Campanha do Dia dos Namorados', 'R. Prates', 'incept/img/9.jpeg')">
                      <div class="gobody overlay">
                          <div class="relative">
                              <h1 class="ptitle">Campanha do Dia dos Namorados</h1>
                              <p class="pauthor">R. Prates</p>
                          </div>
                      </div>
                  </div>
              ...
              <div class="sectionplanos">
                <div class="contplanos">
                  <div class="infoplanos efeito-card1 col-lg-3 col-md-12 col-sm-12 mb-5">           
                    <p class="pretitulo-ligth"><b>PLANOS E PREÇOS</b></p>
                    ...
                    <a rel="noopener noreferrer" href="https://api.whatsapp.com/send/?phone=5538998604242&text=Olá! Gostaria de um plano personalizado&type=phone_number&app_absent=0" target="_blank">
                      <button class="btnpersona btn-highligth btn" style="width: 250px;"><b>ENTRAR EM CONTATO</b></button>
                    </a>
                  </div>
